<span class="time-span">
    <i class="icon-calendar small"></i>{{ encounter.encounterDatetime | serverDate:DatetimeFormats.date }}
    <i class="icon-time small"></i>{{ encounter.encounterDatetime | serverDate:DatetimeFormats.time }}
</span>
