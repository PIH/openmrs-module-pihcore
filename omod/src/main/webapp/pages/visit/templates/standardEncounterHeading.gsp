...
<span class="encounter-provider admission-location" ng-hide="encounter.location.uuid == encounter.visit.location.uuid">${ ui.message("uicommons.at") } {{encounter.location | omrs.display}}</span>