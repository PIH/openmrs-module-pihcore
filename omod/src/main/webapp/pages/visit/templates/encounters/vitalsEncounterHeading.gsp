...
<span class="encounter-provider vitals-header-span">{{ encounter.obs | byConcept:Concepts.temperature:true | obs }}, {{ encounter.obs | byConcept:Concepts.heartRate:true | obs }}, {{ encounter.obs | byConcept:Concepts.respiratoryRate:true | obs }}</span>
