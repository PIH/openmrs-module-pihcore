...
<span class="encounter-provider vitals-header-span"> {{ 'edtriageapp.enteredBy' | translate }} {{ encounter.encounterProviders | orderBy: 'dateCreated'| encounterRole:primaryEncounterRoleUuid | getProviderNameFromDisplayString }}</span>
