...
<span class="encounter-provider vitals-header-span">{{ encounter.obs | byConcept:Concepts.triageQueueStatus:true | obs:{ mode: 'value' } }} {{ 'emr.by' | translate }} {{ encounter.encounterProviders | encounterRole:primaryEncounterRoleUuid | getProviderNameFromDisplayString }}</span>
