...
<div class="row col-12">
    <span class="encounter-card-summary">
        {{ encounter.obs | byConcept:Concepts.triageQueueStatus:true | obs }}
    </span>
</div>
<div class="row justify-content-between">
    <div class="col-8">
        <span class="encounter-card-summary provider-and-location-span">
            {{ 'edtriageapp.enteredBy' | translate }}
            {{ encounter.encounterProviders | orderBy: 'dateCreated'| encounterRole:primaryEncounterRoleUuid | getProviderName }}
        </span>
