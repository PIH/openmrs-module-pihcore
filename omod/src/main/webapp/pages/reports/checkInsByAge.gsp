<%
    ...
    ui.includeJavascript("pihcore", "reports/checkInsByAge.js")
...
<script type="text/javascript">
    var breadcrumbs = [
        ...
        { label: "${ ui.message("mirebalaisreports.checkinoverview.title") }", link: "${ ui.thisUrl() }" }
    ];
</script>
...
<h1>
    ${ ui.message("mirebalaisreports.checkinoverview.title") }
</h1>

<div id="checkins-by-age-app" ng-controller="CheckInsByAgeController" ng-init="runReport()">
    ...
    <div id="results-section">
        ...
        <div id="indicator-table" ng-show="data">
            <table width="100%" border="1" cellspacing="0" cellpadding="2">
                ...
                <tbody>
                    <tr>
                        <td style="width:25%"><%= ui.message("mirebalaisreports.checkinsForAge") %></td>
        ...
        <div id="detail-table" ng-show="selectedCategory">
            ...
            <h4><%= ui.message("mirebalaisreports.checkinsForAge") %> {{ selectedCategory }}</h4>
...
<script type="text/javascript">
    angular.bootstrap('#checkins-by-age-app', [ 'checkInsByAge' ]);
</script>