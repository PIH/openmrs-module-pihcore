...
public class AwaitingAdmissionPageController {
    ...
    public void get(PageModel model,
                    @RequestParam(value = "dispositionType", required = false) List<DispositionType> dispositionTypes,
                    @RequestParam(value = "visitLocation", required = false) Location visitLocation,
                    @RequestParam(value = "dispositionLocation", required = false) Location dispositionLocation,
    ...
    protected String getPrimaryDiagnoses(Encounter encounter, DiagnosisService diagnosisService) {
        ...
        for (Diagnosis diagnosis : diagnoses) {
            if (diagnosis.getDiagnosis() != null) {
                l.add(diagnosis.getDiagnosis().formatWithoutSpecificAnswer(Context.getLocale()));
            }
        }
