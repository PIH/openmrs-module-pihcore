...
public class GlobalPropertiesBundle extends PihMetadataBundle {
    ...
    public void install() throws Exception {
        ...
        properties.put(EmrApiConstants.GP_VISIT_NOTE_ENCOUNTER_TYPE, EncounterTypeBundle.EncounterTypes.CONSULTATION);
        properties.put(EmrApiConstants.GP_CHECK_IN_ENCOUNTER_TYPE, EncounterTypeBundle.EncounterTypes.CHECK_IN);
        properties.put(EmrApiConstants.GP_ADMISSION_ENCOUNTER_TYPE, EncounterTypeBundle.EncounterTypes.ADMISSION);
        properties.put(EmrApiConstants.GP_EXIT_FROM_INPATIENT_ENCOUNTER_TYPE, EncounterTypeBundle.EncounterTypes.EXIT_FROM_CARE);
        properties.put(EmrApiConstants.GP_TRANSFER_WITHIN_HOSPITAL_ENCOUNTER_TYPE, EncounterTypeBundle.EncounterTypes.TRANSFER);
