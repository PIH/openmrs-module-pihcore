...
public class RelationshipTypeBundle extends AbstractMetadataBundle {
    ...
    public static final class RelationshipTypes {
        ...
        public static final String CLINICIAN_PATIENT = "2fa6fcea-aa58-11e8-98d0-529269fb1459";
    }
    ...
    public void install() throws Exception {
        ...
        install(relationshipType("Clinician", "Patient", "Clinician/Patient relationship", RelationshipTypes.CLINICIAN_PATIENT));
