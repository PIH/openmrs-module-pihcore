...
public class MetadataMappingsSetup {
    ...
    public static void setupGlobalMetadataMappings(MetadataMappingService metadataMappingService,
        ...
        metadataMappingService.mapMetadataItem(encounterService.getEncounterTypeByUuid(PihEmrConfigConstants.ENCOUNTERTYPE_CONSULTATION_UUID), EmrApiConstants.EMR_METADATA_SOURCE_NAME, EmrApiConstants.GP_VISIT_NOTE_ENCOUNTER_TYPE);
        metadataMappingService.mapMetadataItem(encounterService.getEncounterTypeByUuid(PihEmrConfigConstants.ENCOUNTERTYPE_CHECK_IN_UUID), EmrApiConstants.EMR_METADATA_SOURCE_NAME, EmrApiConstants.GP_CHECK_IN_ENCOUNTER_TYPE);
        metadataMappingService.mapMetadataItem(encounterService.getEncounterTypeByUuid(PihEmrConfigConstants.ENCOUNTERTYPE_ADMISSION_UUID), EmrApiConstants.EMR_METADATA_SOURCE_NAME, EmrApiConstants.GP_ADMISSION_ENCOUNTER_TYPE);
