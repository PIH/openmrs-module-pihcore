...
public class CustomAppLoaderFactory implements AppFrameworkFactory {
    ...
    private void loadAppsAndExtensions() throws UnsupportedEncodingException {
        ...
        if (config.isComponentEnabled(Components.MCH_TRIAGE)) {
            enableMCHTriage(config);
        }
...
//        }
    ...
    private void enableVisitManagement() {
        ...
        extensions.add(overallAction(CustomAppLoaderConstants.Extensions.CREATE_VISIT_OVERALL_ACTION,
                ...
                and(patientDoesNotHaveActiveVisitAtAnyLocation(), patientNotDead())));
    ...
    private void enableCheckIn(Config config) {
        ...
        Extension checkIn = visitAction(CustomAppLoaderConstants.Extensions.CHECK_IN_VISIT_ACTION,
                ...
                "fas fa-fw icon-check-in",
                "link",
                enterSimpleHtmlFormLink(PihCoreUtil.getFormResource(checkInFormName)),
        ...
        if (config.isCountry(ConfigDescriptor.Country.SIERRA_LEONE)) {
            ...
            extensions.add(cloneAsInfantVisitAction(checkInMaternal));
        ...
        if (config.isCountry(ConfigDescriptor.Country.SIERRA_LEONE)) {
            apps.add(addToClinicianDashboardFirstColumn(app(CustomAppLoaderConstants.Apps.VITALS_SUMMARY,
                            ...
                            objectNode(
                                    ...
                                    "encounterTypes", PihEmrConfigConstants.ENCOUNTERTYPE_VITALS_UUID + "," + SierraLeoneConfigConstants.ENCOUNTERTYPE_SIERRALEONEVITALSNCD_UUID + "," + SierraLeoneConfigConstants.ENCOUNTERTYPE_SIERRALEONEINPATIENTVITALS_UUID + "," + SierraLeoneConfigConstants.ENCOUNTERTYPE_SIERRALEONELABORPROGRESS_UUID + "," + SierraLeoneConfigConstants.ENCOUNTERTYPE_ANCPROGRESS_UUID + "," + SierraLeoneConfigConstants.ENCOUNTERTYPE_SIERRALEONEMCHTRIAGE_UUID + "," + SierraLeoneConfigConstants.ENCOUNTERTYPE_SIERRALEONEPOSTPARTUMPROGRESS_UUID + "," + PihEmrConfigConstants.ENCOUNTERTYPE_NEWBORN_INITIAL_UUID + "," + PihEmrConfigConstants.ENCOUNTERTYPE_NEWBORN_DISCHARGE_UUID + "," + PihEmrConfigConstants.ENCOUNTERTYPE_NEWBORN_DAILY_PROGRESS_UUID + "," + PihEmrConfigConstants.ENCOUNTERTYPE_NEWBORN_ASSESSMENT_UUID + "," + SierraLeoneConfigConstants.ENCOUNTERTYPE_SIERRALEONENICUTRIAGE_UUID + "," + SierraLeoneConfigConstants.ENCOUNTERTYPE_SIERRALEONEPACUFOLLOWUP_UUID + "," + SierraLeoneConfigConstants.ENCOUNTERTYPE_POSTNATALFOLLOWUP_UUID,
    ...
    private void enableMedicationOrder() {
        extensions.add(visitAction(CustomAppLoaderConstants.Extensions.ORDER_DRUG_VISIT_ACTION,
                ...
                null,
                and(sessionLocationHasTag("Drug Order Location"),
                        or(and(userHasPrivilege(PihEmrConfigConstants.PRIVILEGE_TASK_EMR_ENTER_CONSULT_NOTE), patientHasActiveVisit()),
                                userHasPrivilege(PihEmrConfigConstants.PRIVILEGE_TASK_EMR_RETRO_CLINICAL_NOTE),
                                and(userHasPrivilege(PihEmrConfigConstants.PRIVILEGE_TASK_EMR_RETRO_CLINICAL_NOTE_THIS_PROVIDER_ONLY), patientVisitWithinPastThirtyDays(config))))));
    ...
    private void enablePatientRegistration() {
        ...
        if (config.isCountry(ConfigDescriptor.Country.SIERRA_LEONE)) {
            apps.add(addToRegistrationSummarySecondColumnContent(app(CustomAppLoaderConstants.Apps.MOST_RECENT_REGISTRATION_LOCAL_ADDRESS,
                            ...
                            objectNode("encounterDateLabel", "mirebalais.mostRecentRegistration.encounterDateLabel",
                                    "encounterTypeUuid", PihEmrConfigConstants.ENCOUNTERTYPE_PATIENT_REGISTRATION_UUID,
                                    "definitionUiResource", PihCoreUtil.getFormResource("patientRegistration-localAddress.xml"),
                                    "editable", true)),
                    "coreapps",
                    "encounter/mostRecentEncounter"));
        }
...
*/
    ...
    private void enableOncology() {
        ...
        */
        ...
        extensions.add(visitAction(CustomAppLoaderConstants.Extensions.ONCOLOGY_TREATMENT_PLAN_ACTION,
                ...
                "fas fa-fw fa-hand-holding-heart",
                "link",
                enterStandardHtmlFormLink(PihCoreUtil.getFormResource("oncologyTreatment.xml")),
                  PihEmrConfigConstants.PRIVILEGE_TASK_EMR_ENTER_ONCOLOGY_CONSULT_NOTE,
                and(sessionLocationHasTag("Oncology Consult Location"),
                        visitDoesNotHaveEncounterOfType(PihEmrConfigConstants.ENCOUNTERTYPE_ONCOLOGY_TREATMENT_PLAN_UUID),
                        visitDoesNotHaveEncounterOfType(PihEmrConfigConstants.ENCOUNTERTYPE_ONCOLOGY_CONSULT_UUID),
        ...
        extensions.add(visitAction(CustomAppLoaderConstants.Extensions.ONCOLOGY_INITIAL_VISIT_ACTION,
                ...
                "fas fa-fw fa-hand-holding-heart",
                "link",
                enterStandardHtmlFormLink(PihCoreUtil.getFormResource("oncologyIntakeConsult.xml")),
                PihEmrConfigConstants.PRIVILEGE_TASK_EMR_ENTER_ONCOLOGY_CONSULT_NOTE,
                and(sessionLocationHasTag("Oncology Consult Location"),
    ...
    private void enableNCDs() {
        ...
        extensions.add(visitAction(CustomAppLoaderConstants.Extensions.NCD_INITIAL_VISIT_ACTION,
                ...
                and(sessionLocationHasTag("NCD Consult Location"),
                    ...
                    not(patientHasPreviousEncounter(PihEmrConfigConstants.ENCOUNTERTYPE_NCD_INITIAL_1_CONSULT_UUID)),
                    not(patientHasPreviousEncounter(PihEmrConfigConstants.ENCOUNTERTYPE_NCD_INITIAL_2_CONSULT_UUID)),
    ...
    private void enableMCHForms() {
        ...
        if (config.isCountry(ConfigDescriptor.Country.SIERRA_LEONE)) {
            ...
            Extension ayfsIntake = visitAction(CustomAppLoaderConstants.Extensions.AYFS_INITIAL_VISIT_ACTION,
                    ...
                    "link",
                    enterStandardHtmlFormLink(PihCoreUtil.getFormResource("ayfsIntake.xml") + "&returnUrl=/" + WebConstants.CONTEXT_PATH + "/" + patientVisitsPageWithSpecificVisitUrl),  // always redirect to visit page after clicking this link
                    PihEmrConfigConstants.PRIVILEGE_TASK_EMR_ENTER_MCH,
                    and(sessionLocationHasTag("Maternal and Child Location"),
    ...
    private void enableMCOEForms() {
        if (config.isCountry(ConfigDescriptor.Country.SIERRA_LEONE)) {
            ...
            Extension newbornDaily = visitAction(CustomAppLoaderConstants.Extensions.NEWBORN_DAILY_PROGRESS_ACTION,
            ...
            Extension newbornDischarge = visitAction(CustomAppLoaderConstants.Extensions.NEWBORN_DISCHARGE_ACTION,
            ...
            Extension nicuTriage = visitAction(CustomAppLoaderConstants.Extensions.NICU_TRIAGE_ACTION,
                    "pih.task.nicuTriage",
                    "fas fa-fw fa-baby",
                    "link",
            ...
            Extension ldSummary = visitAction(CustomAppLoaderConstants.Extensions.LABOR_DELIVERY_SUMMARY_ACTION,
                    ...
                    PihEmrConfigConstants.PRIVILEGE_TASK_EMR_ENTER_MCH,
                    and(sessionLocationHasTag("Delivery Location"),
    ...
    private void enableVaccinationOnly() {
        ...
        extensions.add(cloneAsInfantVisitAction(vaccination));
    }
        ...
        if (config.isCountry(ConfigDescriptor.Country.HAITI)) {
            ...
            extensions.add(visitAction(CustomAppLoaderConstants.Extensions.PRIMARY_CARE_PEDS_INITIAL_VISIT_ACTION,
                    ...
                    and(sessionLocationHasTag("Primary Care Consult Location"),
                            ...
                            or(patientIsChild(), patientAgeUnknown(), patientDoesNotHaveActiveVisit()),
            ...
            extensions.add(visitAction(CustomAppLoaderConstants.Extensions.PRIMARY_CARE_ADULT_INITIAL_VISIT_ACTION,
                    ...
                    and(sessionLocationHasTag("Primary Care Consult Location"),
                            ...
                            or(patientIsAdult(), patientAgeUnknown(), patientDoesNotHaveActiveVisit()),
                            or(and(userHasPrivilege(  PihEmrConfigConstants.PRIVILEGE_TASK_EMR_ENTER_PRIMARY_CARE_CONSULT_NOTE), patientHasActiveVisit()),
                                    userHasPrivilege(  PihEmrConfigConstants.PRIVILEGE_TASK_EMR_RETRO_CLINICAL_NOTE),
                                    and(userHasPrivilege(  PihEmrConfigConstants.PRIVILEGE_TASK_EMR_RETRO_CLINICAL_NOTE_THIS_PROVIDER_ONLY), patientVisitWithinPastThirtyDays(config))))));
...
//       Condition List in HIV Dashboard
    ...
    private void enableLabs() throws UnsupportedEncodingException {
        ...
        // note that this is only currently accessed via the Lab Workflow "Add Order" button, and the returnUrl and addResultsUrl are both hardcoded below for this
    ...
    private void enablePatientDocuments() {
        apps.add(addToClinicianDashboardSecondColumn(app(CustomAppLoaderConstants.Apps.PATIENT_DOCUMENTS,
                ...
                null),
                "coreapps", "attachments/dashboardWidget"));
        ...
        extensions.add(overallAction(CustomAppLoaderConstants.Extensions.PATIENT_DOCUMENTS_OVERALL_ACTION,
                ...
                "fas fa-fw fa-paperclip",
                "link",
                "coreapps/attachments/attachments.page?patient={{patient.uuid}}&patientId={{patient.patientId}}",
                  PihEmrConfigConstants.PRIVILEGE_APP_ATTACHMENTS_PAGE,
                null));
    }
