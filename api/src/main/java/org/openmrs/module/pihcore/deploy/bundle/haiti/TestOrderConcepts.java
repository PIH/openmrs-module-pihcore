...
public class TestOrderConcepts extends VersionedPihConceptBundle {
    ...
    protected void installNewVersion() throws Exception {
        install(new ConceptNumericBuilder(Concepts.HEMATOCRIT)
                ...
                .datatype(numeric)
                .conceptClass(test)
                .name("3e148d20-26fe-102b-80cb-0017a47871b2", "Hematocrit", Locale.ENGLISH, ConceptNameType.FULLY_SPECIFIED)
                ...
                .name("f5bf7046-d5db-102d-ad2a-000c29c2a5d7", "Hématocrite", Locale.FRENCH, null) // locale-preferred
        ...
        install(new ConceptNumericBuilder(Concepts.HEMOGLOBIN)
                ...
                .datatype(numeric)
                .conceptClass(test)
                .name("3e09b800-26fe-102b-80cb-0017a47871b2", "Hemoglobin", Locale.ENGLISH, ConceptNameType.FULLY_SPECIFIED)
                ...
                .name("f5611438-d5db-102d-ad2a-000c29c2a5d7", "Hémoglobine", Locale.FRENCH, null) // locale-preferred
